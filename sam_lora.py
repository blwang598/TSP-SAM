...
class LoRA_TinySam(LoRA):
    ...
    def __init__(self, sam_model: Sam, r: int, lora_layer=None):
        super(LoRA_TinySam, self).__init__()
        ...
        if lora_layer:
            ...
            all_layers = sam_model.image_encoder.layers
            for layer in all_layers:
                if layer.name == "BasicLayer":
                    for block in layer.blocks:
                        lora_layers.append(block)
